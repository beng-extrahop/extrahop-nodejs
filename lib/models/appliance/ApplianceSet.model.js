...
module.exports = function (_BaseObjectSet) {
  ...
  _createClass(ApplianceSet, [{
    key: 'writeToCSV',
    value: function writeToCSV(_ref2) {
      var _ref2$filename = _ref2.filename,
          filename = _ref2$filename === undefined ? 'appliances-' + this.generateId() + '.csv' : _ref2$filename,
          subkey = _ref2.subkey;

      _get(ApplianceSet.prototype.__proto__ || Object.getPrototypeOf(ApplianceSet.prototype), 'writeToCSV', this).call(this, { filename: filename, subkey: subkey });
    }
  }]);
