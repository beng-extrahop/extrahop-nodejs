...
module.exports = function (_BaseObjectSet) {
  ...
  function DashboardSet() {
    ...
    for (var _len = arguments.length, dashboards = Array(_len), _key = 0; _key < _len; _key++) {
      dashboards[_key] = arguments[_key];
    }

    return _possibleConstructorReturn(this, (_ref = DashboardSet.__proto__ || Object.getPrototypeOf(DashboardSet)).call.apply(_ref, [this].concat(_toConsumableArray(dashboards.map(function (dashboard) {
  ...
  _createClass(DashboardSet, [{
    ...
    value: function writeToCSV(_ref2) {
      var _ref2$filename = _ref2.filename,
          filename = _ref2$filename === undefined ? 'dashboards-' + this.generateId() + '.csv' : _ref2$filename,
          subkey = _ref2.subkey;
...
//# sourceMappingURL=DashboardSet.model.js.map